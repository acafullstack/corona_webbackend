@include('layouts.header')
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            ...
            @endif
          <form class="form-horizontal" method="POST" action="{{ url('store/news') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
        <div class="col-sm-6">
            ...
            <div class="col-sm-12" style="text-align: center;">
               <div class="form-group">
                    ...
                    <label style="display: none;">
								...
								<img id="blah" src="{{url('assets/images/news/dummy.jpg')}}" style=" width: 170px; height: 170px; padding: 9px; border-radius: 50%;" />
								</div>
 ...
 <div class="row">
       ...
       <div class="col-sm-12 text-center">
        <button type="submit" class="btn pl-5 pr-5 btn-success" id="submits" style="margin-bottom: 10px;">Save</button>
        </div>
</div>
      </form>
