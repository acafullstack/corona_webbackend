...
<body>
    <h3>Report Status according to your request.</h3>
    <div>
        <p>You situation is <strong>{{$situation}}</strong></p>
    </div>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <p>This is to notify you that a report has been received from the Coronavirus Tracking system with the following details:</p>
						  ...
						  <thead>
						    <tr>
						      ...
						      <th style="   padding: 4px;     background: #f2f2f2;color: #000;">First</th>
						...
						<p><a href="#" style="color: #000;text-decoration: none;margin-bottom: 0;    margin-top: 2px;">Lagos</a></p>
						<p><a href="#" style="color: #000;text-decoration: none;margin-bottom: 0;    margin-top: 2px;">Nigeria</a></p>
						<p><a href="tel:#" style="color: #000;text-decoration: none;margin-bottom: 0;    margin-top: 2px;">08137548264</a></p>
                      </td>
                    </tr>
